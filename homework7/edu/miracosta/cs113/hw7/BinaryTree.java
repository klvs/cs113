...
public class BinaryTree<E> implements Serializable {
 ...
 // Insert solution to programming exercise 1, section 3, chapter 6 here
    ...
    public String preorderString() {
    	...
    	preorderString(builder, root);
    	return builder.toString();
    }

    // recursive function that does the traversal
    public void preorderString(StringBuilder builder, Node<E> root) {
    	builder.append(root);
    	if(root.left != null) {
    		builder.append(" ");
    		preorderString(builder, root.left);
    	}
    	if(root.right != null) {
    		builder.append(" ");
    		preorderString(builder, root.right);
    	}
    }
...
// Insert solution to programming exercise 2, section 3, chapter 6 here
    ...
    public String postorderString() {
    	StringBuilder builder = new StringBuilder();
    	postorderString(builder, root);
    	return builder.toString();
    }

    // recursive function that does the traversal
    public void postorderString(StringBuilder builder, Node<E> root) {
    	if(root.left != null) {
    		builder.append(" ");
    		postorderString(builder, root.left);
    	}
    	if(root.right != null) {
    		builder.append(" ");
    		postorderString(builder, root.right);
    	}
    	builder.append(root);
    }
...
// Insert solution to programming exercise 3, section 3, chapter 6 here
    ...
    public String inorderString() {
    	StringBuilder builder = new StringBuilder();
    	inorderString(builder, root);
    	return builder.toString();
    }

    // recursive function that does the traversal
    public void inorderString(StringBuilder builder, Node<E> root) {
    	if(root.left != null) {
    		builder.append("(");
    		preorderString(builder, root.left);
    		builder.append(")");
